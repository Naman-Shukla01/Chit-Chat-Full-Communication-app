...
const updateGroup = async (req, res) => {
  ...
  let updatedGroup = await Group.findByIdAndUpdate(groupId, {groupname: name, password},{new: true});
  return res.status(200).json({message: "Group Updated Successfully", groupId: updatedGroup._id,groupname: updatedGroup.groupname});
